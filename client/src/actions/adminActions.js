...
export const loginAdmin = (admin) => async dispatch => {
    ...
    try {
        const response = await axios.post(`${baseURL}/api/admins/login`, admin)
...
export const addAdmin = (admin) => async dispatch => {
    ...
    try {
        const response = await axios.post(`${baseURL}/api/admins/addAdmin`, admin)
        console.log(response);
...
export const deleteAdminAction = (adminID) => async dispatch => {
    ...
    try {
        const response = await axios.delete(`${baseURL}/api/admins/delete/admin/${adminID}`)
