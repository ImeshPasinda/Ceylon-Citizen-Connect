      ...
      axios
        ...
        .then((res) => {
          ...
          administrativeCount = res.data.filter(
            (applicant) => applicant.jobCategory === "Administrative"
          ).length;
          inventoryCount = res.data.filter(
            (applicant) => applicant.jobCategory === "Inventory"
          ).length;
          generalCount = res.data.filter(
            (applicant) => applicant.jobCategory === "General"
          ).length;
          ...
          <div class="modal-content">
            ...
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalToggleLabel">
                {" "}
                Detailed Report about Job Applicants
              </h5>
